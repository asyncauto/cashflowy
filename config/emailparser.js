    ...
    filters: [
        {
            ...
            modifyData: function (pe) {
                if (pe.body_parser_used == 'received_money_v1'||pe.body_parser_used == 'money_added_v1'||pe.body_parser_used == 'received_cashback_v1'||pe.body_parser_used == 'money_added_automatically_v1') {
